...
<ul class="sidebar-menu">
    ...
    <?php if ($permisos == "super_admin"): ?>
        ...
        <li class="treeview <?= $active_compras ?>">
            ...
            <ul class="treeview-menu">
                <li class="<?= ($currentController == 'Deposito') ? 'active' : '' ?>"><a href="index.php?controller=Deposito&action=index"><i class="fa fa-circle-o"></i>Depósito</a></li>
                <li class="<?= ($currentController == 'Proveedor') ? 'active' : '' ?>"><a href="index.php?controller=Proveedor&action=index"><i class="fa fa-circle-o"></i>Proveedor</a></li>
                <li class="<?= ($currentController == 'Producto') ? 'active' : '' ?>"><a href="index.php?controller=Producto&action=index"><i class="fa fa-circle-o"></i>Producto</a></li>
                <li class="<?= ($currentController == 'UnidadMedidas') ? 'active' : '' ?>"><a href="index.php?controller=UnidadMedidas&action=index"><i class="fa fa-circle-o"></i>Unidad de Medidas</a></li>
            </ul>
        </li>
        ...
        <li class="treeview <?= $active_ventas ?>">
            ...
            <ul class="treeview-menu">
                <li class="<?= ($currentController == 'Clientes') ? 'active' : '' ?>"><a href="index.php?controller=Clientes&action=index"><i class="fa fa-circle-o"></i>Clientes</a></li>
            </ul>
        </li>
